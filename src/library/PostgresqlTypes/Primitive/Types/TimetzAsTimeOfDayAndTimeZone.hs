module PostgresqlTypes.Primitive.Types.TimetzAsTimeOfDayAndTimeZone (TimetzAsTimeOfDayAndTimeZone) where
...
data TimetzAsTimeOfDayAndTimeZone
  ...
  deriving (IsPrimitive, Arbitrary, Show) via (ViaIsMany Timetz TimetzAsTimeOfDayAndTimeZone)
