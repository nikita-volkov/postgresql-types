...
main =
  hspec do
    withPqConnection do
      ...
      withType @(PrimitiveLayer.Range PrimitiveLayer.Numeric) [mappingSpec]
      withType @(PrimitiveLayer.Range PrimitiveLayer.Timestamp) [mappingSpec]
      withType @(PrimitiveLayer.Range PrimitiveLayer.Timestamptz) [mappingSpec]
      withType @(PrimitiveLayer.Range PrimitiveLayer.Date) [mappingSpec]
      withType @(PrimitiveLayer.Multirange PrimitiveLayer.Int4) [mappingSpec]
      withType @(PrimitiveLayer.Multirange PrimitiveLayer.Int8) [mappingSpec]
      withType @(PrimitiveLayer.Multirange PrimitiveLayer.Numeric) [mappingSpec]
      withType @(PrimitiveLayer.Multirange PrimitiveLayer.Timestamp) [mappingSpec]
      withType @(PrimitiveLayer.Multirange PrimitiveLayer.Timestamptz) [mappingSpec]
      withType @(PrimitiveLayer.Multirange PrimitiveLayer.Date) [mappingSpec]
